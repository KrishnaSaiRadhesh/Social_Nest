...
const UserProfile = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const profileRes = await axios.get(
          `https://social-nest-backend.onrender.com/api/user/${id}`,
          {
  ...
  const handleFollow = async () => {
    try {
      await axios.post(
        `https://social-nest-backend.onrender.com/api/user/follow/${id}`,
        {},
        { withCredentials: true }
      );
      setIsFollowing(true);
  ...
  const handleUnFollow = async () => {
    try {
      await axios.post(
        `https://social-nest-backend.onrender.com/api/user/unfollow/${id}`,
        {},
        { withCredentials: true }
      );
