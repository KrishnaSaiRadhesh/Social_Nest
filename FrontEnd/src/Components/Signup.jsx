    ...
    <div className="min-h-screen flex items-center justify-center w-[100vw] gap-50 bg-gradient-to-br from-white to-blue-100 p-4">
      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-lg p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to={"/Login"}>
          <button className="text-sm text-white bg-blue-600 px-4 py-2 rounded-full">Login</button>
          </Link>
        </div>

        {/* Sign In Title */}
        <h2 className="text-2xl font-bold text-center text-black mb-1">Sign Up</h2>
        <p className="text-sm text-gray-500 text-center mb-6">Enter your details to proceed further</p>

       <form onSubmit={handleSubmit}>
          <div className="mb-4">
              <label className="text-sm font-medium text-gray-700 border-gray-700">Name</label>
