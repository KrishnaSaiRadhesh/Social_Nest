...
//   return (
//     <div className="bg-gray-100 p-3 shadow-lg flex items-center justify-between relative">
//       <div className="Logo flex items-center pl-20  sm:gap-3">
//         <img
...
//     const fetchUser = async () => {
//       try {
//         const res = await api.get("/auth/user"); // Use api.js
//         const data = res.data;
...
//   const handleLogout = async () => {
//     try {
//       const res = await api.post("/auth/logout", {}, { withCredentials: true }); // Use api.js
//       if (res.data.success) {
//         setImage("");
//         setModelopen(false);
//         localStorage.clear();
...
const Header = () => {
  ...
  if (!image) {
    return (
      <div className="bg-gray-100 p-3 shadow-lg flex items-center justify-between relative w-full animate-pulse">
        <div className="flex items-center pl-4 sm:pl-8 md:pl-12 lg:pl-20 gap-2 sm:gap-3">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-300 rounded-full"></div>
          <div className="h-6 sm:h-7 md:h-8 lg:h-9 bg-gray-300 rounded w-24"></div>
        </div>
        <div className="relative pr-4 sm:pr-8 md:pr-12 lg:pr-20">
          <div className="flex items-center justify-center gap-4 sm:gap-5">
