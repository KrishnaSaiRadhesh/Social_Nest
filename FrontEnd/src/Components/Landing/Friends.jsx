...
// import api from "axios"; // Corrected import to "../../api"
// import React, { useEffect, useState } from "react";
// import { FiSearch } from "react-icons/fi";
// import { useNavigate } from "react-router-dom";
...
//       setLoading(true);
//       try {
//         const res = await api.get("/auth/friends"); // Use api
//         const data = res.data;
...
//         const profileRes = await api.get("/user/user"); // Use api
//         const followingList = profileRes.data.following || [];
//         const followStatus = {};
//         validUsers.forEach((user) => {
//           followStatus[user._id] = followingList.includes(user._id);
...
//   const handleFollow = async (userId) => {
//     try {
//       await api.post(`/user/follow/${userId}`); // Use api
//       setFollowing((prev) => ({ ...prev, [userId]: true }));
//     } catch (error) {
//       console.log("Error following user:", error);
//     }
...
//   const handleUnFollow = async (userId) => {
//     try {
//       await api.post(`/user/unfollow/${userId}`); // Use api
//       setFollowing((prev) => ({ ...prev, [userId]: false }));
//     } catch (error) {
//       console.log("Error unfollowing user:", error);
//     }
