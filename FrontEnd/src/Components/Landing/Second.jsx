...
//       await axios.post(
//         "https://localhost:3000/api/stories/create",
//         {
//           media: storyImage,
//           mediaType: "image",
//           description: storyDescription,
...
//       render: "Story created successfully!",
//       type: "success",
//       isLoading: false,
//       autoClose: 1000,
//     });
...
//       console.error("Error creating story:", error);
//      toast.update(toastId, {
//       render: error.response?.data?.message || "Failed to create story.",
//       type: "error",
//       isLoading: false,
//       autoClose: 3000,
//     });
...
//       setLoading(true);
//       const res = await axios.put(
//         `https://localhost:3000/api/stories/${editingStory}`,
//         {
//           media: editStoryImage,
//           mediaType: "image",
//           description: editStoryDescription,
...
//       setLoading(true);
//       await axios.delete(
//         `https://localhost:3000/api/stories/${storyId}`,
//         {
//           withCredentials: true,
//         }
//       );
...
//     try {
//       await axios.post(
//         `https://localhost:3000/api/stories/${userStories[index]._id}/view`,
//         {},
//         { withCredentials: true }
//       );
//     } catch (error) {
...
const Second = () => {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        ...
        setProfileImage(res.data.image || res.data.googleImage || "/Profile.png");
        setCurrentUserId(res.data._id);
      } catch (error) {
        console.error("Error fetching user:", error);
  ...
  const handleStoryUpdate = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await api.put(`/stories/${editingStory}`, {
        media: editStoryImage,
        mediaType: "image",
        description: editStoryDescription,
      });
  ...
  const handleStoryClick = async (userStories, index) => {
    ...
    setStoryIndex(index);
    try {
      await api.post(`/stories/${userStories[index]._id}/view`);
    } catch (error) {
      console.error("Error marking story as viewed:", error);
    }
  };
...
//     return (
//       <div className="py-1 pb-16 lg:pb-0">
//         <div className="Status bg-white shadow-lg rounded-2xl p-3 flex items-center w-full gap-5 overflow-x-auto animate-pulse">
//           <div className="flex flex-col items-center flex-shrink-0">
//             <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gray-300 rounded-full"></div>
...
//         <div className="bg-white shadow-lg w-full p-4 sm:p-5 mt-2 rounded-2xl flex flex-col gap-2 animate-pulse">
//           <div className="flex gap-2 items-center">
//             <div className="w-8 sm:w-10 h-8 sm:h-10 bg-gray-300 rounded-full"></div>
//             <div className="h-6 bg-gray-300 rounded w-3/4"></div>
//           </div>
//           <div className="h-[150px] sm:h-[200px] bg-gray-300 rounded-xl"></div>
...
//           <div className="bg-white shadow-lg p-4 rounded-2xl animate-pulse">
//             <div className="flex gap-2 items-center">
//               <div className="w-8 sm:w-10 h-8 bg-gray-300 rounded-full"></div>
//               <div className="space-y-2 w-full">
//                 <div className="h-4 bg-gray-300 rounded w-1/2"></div>
//                 <div className="h-4 bg-gray-300 rounded w-3/4"></div>
//               </div>
//             </div>
//             <div className="h-48 bg-gray-300 rounded mt-2"></div>
