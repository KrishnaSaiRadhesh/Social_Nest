...
//                         <div>
//                             <h2 className='font-semibold'>{followers?.length}</h2>
//                             <p>followers</p>
//                         </div>

//                         <div >
//                             <h2 className='font-semibold'>{following?.length}</h2>
//                             <p>Following</p>
//                         </div>
...
const First = ({ socket }) => {
  ...
  <div>
      ...
      <div className="text-xs text-gray-500 flex space-x-2 mt-2 px-5">
