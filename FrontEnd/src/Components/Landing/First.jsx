...
//       try {
//         setLoading(true);
//         const res = await api.get("/auth/user"); // Use /user/profile for consistency
//         if (!res.data || res.status !== 200) {
//           throw new Error("Invalid response from server");
//         }

//         const data = res.data;
//         console.log("Profile data:", data); // Debug the response
...
//           setTimeout(() => navigate("/login"), 1000); // Delay to show error
//         } else {
...
//       <div className="hidden lg:block md:hidden">
//         <div className="bg-white shadow-lg p-5 rounded-2xl">
//           <div className="Profile xl:p-5 bg-gray-50 rounded-2xl">
//             <div className="pro-sec flex gap-2 items-center">
//               <img
//                 src={image}
//                 alt="Profile_image"
...
//               />
//               <div>
//                 <h1 className= "font-semibold text-2xl lg:text-[18px]">{name}</h1>
//                 <p className="lg:text-[13px]">{email}</p>
//               </div>
//             </div>
//           </div>
//           <div className="section2 flex items-center justify-around mt-3">
