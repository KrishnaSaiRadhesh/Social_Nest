...
// const { protectRoute } = require("../Middleware/Protect");
// const PostModel = require("../Models/PostModel");
// const UserModel = require("../Models/Auth"); // Renamed for consistency

// // Align endpoint with frontend /api/user
// router.get("/user", protectRoute, GETPROFILE); // Changed from /Profile to /user
// router.post("/Signup", SIGNUP);
// router.post("/login", LOGIN);
// router.post("/logout", LOGOUT);
// router.get("/allUsers", protectRoute, GETALLUSER);
...
// // Move save/unsave under /api/posts to match frontend
