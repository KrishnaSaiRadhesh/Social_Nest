...
// const Story = require('../Models/Story'); // Ensure path and case are correct
// const User = require('../Models/Auth'); // Adjust to correct User model path (e.g., not Auth)
// const { protectRoute } = require('../Middleware/Protect'); // Verify this path
